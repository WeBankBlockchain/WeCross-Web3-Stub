...
contract WeCrossHub {
    ...
    string constant private CALL_TYPE_QUERY = "0";
    string constant private CALL_TYPE_INVOKE = "1";
    string constant private CALL_TYPE_GET_BLOCK = "2";

    uint256 private increment = 0;
    uint256 private currentIndex = 0;

    mapping(uint256 => string) private requests;
    mapping(string => string[]) private callbackResults;
